...
if __name__ == "__main__":
    ...
    # path to VRB
    vrb_path = Path(__file__).parent.resolve()
    
    # path to image
    # img_path = f'{vrb_path}/kitchen.jpeg'
    img_path = f'{vrb_path}/frame_00035.png'
    
    # path to model checkpoint
    model_ckpt = f'{vrb_path}/models/model_checkpoint_1249.pth.tar'
