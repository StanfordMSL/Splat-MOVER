...
class Grasp():
    def __init__(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 0:
            self.grasp_array = np.array([0, 0.02, 0.02, 0.02, 1, 0, 0, 0, 1 ,0 , 0, 0, 1, 0, 0, 0, -1], dtype = float)
        elif len(args) == 1:
            ...
            self.grasp_array = np.concatenate([np.array((score, width, height, depth)),rotation_matrix.reshape(-1), translation, np.array((object_id)).reshape(-1)]).astype(float)
        else:
    ...
    def rotation_matrix(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 1:
            self.grasp_array[4:13] = np.array(args[0],dtype = float).reshape(9)
        elif len(args) == 9:
            self.grasp_array[4:13] = np.array(args,dtype = float)
    ...
    def translation(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 1:
            self.grasp_array[13:16] = np.array(args[0],dtype = float)
        elif len(args) == 3:
            self.grasp_array[13:16] = np.array(args,dtype = float)
...
class GraspGroup():
    def __init__(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 0:
            self.grasp_group_array = np.zeros((0, GRASP_ARRAY_LEN), dtype=float)
        elif len(args) == 1:
...
class RectGrasp():
    def __init__(self, *args):
        ...
        **Input:**
        ...
        if len(args) == 1:
            ...
            self.rect_grasp_array = np.array(args).astype(float)
        else:
    ...
    def open_point(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 1:
            self.rect_grasp_array[2:4] = np.array(args[0],dtype = float)
        elif len(args) == 2:
            self.rect_grasp_array[2:4] = np.array(args,dtype = float)
    ...
    def center_point(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 1:
            self.rect_grasp_array[0:2] = np.array(args[0],dtype = float)
        elif len(args) == 2:
            self.rect_grasp_array[0:2] = np.array(args,dtype = float)
...
class RectGraspGroup():
    def __init__(self, *args):
        ...
        **Input:**
        ...
        '''
        if len(args) == 0:
            self.rect_grasp_group_array = np.zeros((0, RECT_GRASP_ARRAY_LEN), dtype=float)
        elif len(args) == 1:
            if isinstance(args[0], np.ndarray):
    ...
    def to_grasp_group(self, camera, depths, depth_method = batch_center_depth):
        ...
        **Output:**
        ...
        grasp_group.grasp_group_array = copy.deepcopy(np.hstack((scores, widths, heights, depths, rotations, translations, object_ids))).astype(float)
        return grasp_group
